...
[_Подробнее_](./src/1_functions.md#anext)
- __any__: Возвращает True, если какой-либо элемент итерируемого объекта имеет значение True.
[_Подробнее_](./src/1_functions.md#any)
- __ascii__: Возвращает строку, содержащую печатное представление объекта.
