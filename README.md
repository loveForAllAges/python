...
## Встроенные функции
- __abs(x)__: Возвращает абсолютное значение числа.
[Подробнее](./src/1_functions.md#abs)
- __aiter(async_iterable)__: Возвращает асинхронный итератор для асинхронной итерации.
[Подробнее](./src/1_functions.md#aiter)
